...
#define HREF 26
#define PCLK 22
#define TCP_CHUNK_SIZE 1460       // 1回の送信サイズ (TCPのMSSに合わせると効率的)
...
void ov7675_init() {
    ...
    // カラーマトリックスをデフォルト値に設定
    ov7675_write(0x4F, 0x40); // MTX1
    ov7675_write(0x50, 0x34); // MTX2
    ov7675_write(0x51, 0x0c); // MTX3
    ov7675_write(0x52, 0x17); // MTX4
    ov7675_write(0x53, 0x29); // MTX5
    ov7675_write(0x54, 0x40); // MTX6
    ov7675_write(0x58, 0x1A); // MTXS (符号ビット設定)
